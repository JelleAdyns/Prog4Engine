...
namespace dae
{
	...
	class TrashTheCacheGameObjectsComponent final : public Component
	{
	public:
		explicit TrashTheCacheGameObjectsComponent(GameObject* pOwner, int nrOfSamples, const std::string& nameOfGuiWindow);
